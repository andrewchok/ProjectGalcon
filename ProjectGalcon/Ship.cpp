...
ShipC::ShipC(Coord2D destPos, Coord2D startPos, int32_t numOfShipsPerShip, uint32_t color)
{
...
bool ShipC::checkCollisions(Coord2D position, float_t radius)
{
...
void ShipC::update(DWORD milliseconds)
{
...
void ShipC::flock(std::vector<ShipC*> shipList)
{
	Coord2D flockVector;
	flockVector.x = 0;
	flockVector.y = 0;
...
Coord2D ShipC::flockSeparation(std::vector<ShipC*> shipList)
{
	Coord2D sepVec = { 0,0 };
	int32_t count = 0;
...
Coord2D ShipC::flockCohesion(std::vector<ShipC*> shipList)
{
	Coord2D cohVec = { 0,0 };
	int32_t count = 0;
...
Coord2D ShipC::steerTo(Coord2D target)
{
...
Coord2D ShipC::flockAlignment(std::vector<ShipC*> shipList)
{
	Coord2D aliVec = { 0,0 };
	int32_t count = 0;
