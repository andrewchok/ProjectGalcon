...
void ReshapeGL (int width, int height)						// Reshape The Window When It's Moved Or Resized
{
	...
	glOrtho(0, width, 0, height, -800.0, 800.0);
...
BOOL CreateWindowGL (GL_Window* window)									// This Code Creates Our OpenGL Window
{
	...
	PIXELFORMATDESCRIPTOR pfd =											// pfd Tells Windows How We Want Things To Be
	{
		...
		static_cast<BYTE>(window->init.bitsPerPixel),					// Select Our Color Depth
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    *stdin = *hf_in;
	...
	char8_t				title[20];
	strncpy(title,CGame::GetInstance()->mGameTitle,19);
	...
	window.init.width			= CGame::SCREEN_WIDTH;						// Window Width
	window.init.height			= CGame::SCREEN_HEIGHT;						// Window Height
	window.init.bitsPerPixel	= CGame::BITS_PER_PIXEL;						// Bits Per Pixel
